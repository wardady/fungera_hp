...
struct Config {
    ...
    int random_rate = 5, organism_death_rate = 100, max_num_of_mutations_rad = 1;
    size_t cycle_gap = 10000, stack_length = 8, kill_if_no_child = 25000;
    double memory_full_ratio = 0.9, kill_organisms_ratio = 0.5, radiation_mutation_rate = 1.0, mutation_on_reproduction_rate = 0.0;
